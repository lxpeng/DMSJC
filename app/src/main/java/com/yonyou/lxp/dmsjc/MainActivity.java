...
import com.yonyou.lxp.dmsjc.utils.X5WebView;
...
//        webView.loadUrl("http://dms.changan.com.cn/jc-app/JC_UI/login.html");
//    }
//
//    @Override
...
//    private static final String mHomeUrl = "file:///android_asset/JC_UI/login.html";
    ...
    private void init() {
        ...
        mWebView.setWebViewClient(new com.tencent.smtt.sdk.WebViewClient() {
            ...
            @Override
            public WebResourceResponse shouldInterceptRequest(com.tencent.smtt.sdk.WebView view,
